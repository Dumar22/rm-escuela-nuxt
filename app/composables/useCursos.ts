...
const cursos: Curso[] = [
  ...
  },
  {
    ...
    title: 'Maquillaje',
    subtitle: 'MAKEUP SOCIAL & MODA · VISAGISMO Y TRANSFORMACIÓN VISUAL',
    shortDesc: 'Maquillaje de moda, social y visagismo con enfoque técnico y creativo.',
    description: 'Este curso de 24 horas está diseñado para interesados de maquillaje de moda, social y visagismo, para un público amplio que busca desde una base técnica sólida hasta la especialización en el sector de la imagen personal.\n\nInteresados en moda y publicidad: aquellos que desean orientar su carrera hacia pasarelas, sesiones de fotos o medios audiovisuales, donde se requiere un maquillaje más técnico y creativo.\n\nPerfiles del sector belleza: estilistas, asesores de imagen y peluqueros que necesitan dominar el visagismo (estudio de la morfología del rostro) para ofrecer un servicio integral que potencie los rasgos de sus clientes.\n\nPersonas del común que solo quieren aprender a maquillarse para sus eventos sociales o proyectos personales.',
    category: 'Belleza',
    ...
    detailImages: ['/cursos-detalle/maquillaje-profesional-1.jpg', '/cursos-detalle/maquillaje-profesional-2.jpg'],
    price: '340.000',
    currency: 'COP',
    featured: false,
    order: 14
  },
  {
    ...
    title: 'Podcast',
    subtitle: 'CREACIÓN Y PRODUCCIÓN · DESARROLLO INFORMATIVO DIGITAL',
    shortDesc: 'Diseña, produce y comunica en formato podcast con enfoque informativo digital.',
    description: 'Este curso de 24 horas está diseñado para un público amplio que va desde aficionados hasta profesionales que buscan nuevas formas de comunicación digital.\n\nDependiendo del enfoque del curso, los perfiles principales incluyen perfiles creativos y comunicadores.\n\nComunicadores y periodistas: profesionales que desean adaptar sus habilidades narrativas al formato de audio digital para contar historias de manera innovadora.\n\nAficionados a temas específicos: personas apasionadas por la literatura, el cine, la música o la moda que quieren compartir su conocimiento con una audiencia.\n\nCreadores de contenido: individuos que ya tienen presencia en redes sociales y buscan diversificar sus canales o construir una comunidad más cercana.',
    ...
    detailImages: ['/cursos-detalle/podcasts-creacion-y-produccion-1.jpg', '/cursos-detalle/podcasts-creacion-y-produccion-2.jpg'],
    price: '320.000',
    currency: 'COP',
    featured: false,
    order: 15
